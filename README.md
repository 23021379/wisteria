...
*   **Comparative Intelligence:** An automated Pro/Con generator and "Persona-Based Scorecard" that conversationally compares favorited properties, eliminating the need for user spreadsheets.
...
*   **Dynamic Desire Maps:** Interactive choropleth maps (Mapbox GL JS) that allow users to visually prospect neighborhoods based on their own weighted desires (crime rates, pub accessibility, deprivation indices).
